...
import type { Batch, BatchMetadata } from "./ai-config-types";
...
export default function BatchManagementTab({ initialBatches, setMessage }: Props) {
  const [batchRows, setBatchRows] = useState<Batch[]>(initialBatches);
